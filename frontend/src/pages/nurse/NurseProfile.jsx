                                        ...
                                        <form onSubmit={handleSave} className="space-y-4">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        type="text" name="emergencyContactName" value={formData.emergencyContactName} onChange={handleInputChange} required
                                                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 text-slate-800 dark:text-slate-200 transition"
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        type="text" name="emergencyContactRelation" value={formData.emergencyContactRelation} onChange={handleInputChange} required
                                                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 text-slate-800 dark:text-slate-200 transition"
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        type="text" name="emergencyContactPhone" value={formData.emergencyContactPhone} onChange={handleInputChange} required
                                                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 text-slate-800 dark:text-slate-200 transition"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div className="pt-5 border-t border-slate-100 dark:border-slate-800">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl">
                                                    <div>
                                                        ...
                                                        <p className="text-slate-800 dark:text-slate-200 font-medium">{profile.emergencyContact?.name}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Relationship</p>
                                                        <p className="text-slate-800 dark:text-slate-200 font-medium">{profile.emergencyContact?.relationship}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Phone</p>
                                                        <p className="text-slate-800 dark:text-slate-200 font-medium">{profile.emergencyContact?.phone}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
