...
router.get('/staff/:role', authenticate, authorize(['system_admin', 'hospital_admin', 'doctor', 'nurse', 'receptionist']), StaffHelperController.getStaffByRole);
...
router.post('/:id/close', authenticate, authorize(['system_admin', 'hospital_admin', 'doctor']), VisitController.closeVisit);
