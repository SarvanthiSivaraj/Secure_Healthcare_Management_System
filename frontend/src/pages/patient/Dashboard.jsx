            ...
            <div className="max-w-[1440px] mx-auto glass-panel rounded-3xl min-h-[90vh] shadow-2xl flex overflow-hidden">
                    ...
                    <header className="mb-10">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">{user?.firstName || 'Patient Name'} {user?.lastName || ''} • Patient ID: {user?.id || 'JD-061025-001'}</p>
                            </div>
                            ...
                            <div onClick={() => navigate('/patient/medical-records')} className="glass-card p-6 rounded-3xl hover:bg-white/80 dark:hover:bg-slate-800/80 transition-all cursor-pointer group">
                                ...
                                <div className="bg-teal-50/50 dark:bg-teal-900/20 p-4 rounded-2xl border border-teal-100/50 dark:border-teal-500/10">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-medium text-slate-700 dark:text-slate-200">Found: {stats.medicalRecords} Records</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        <section>
                            <div className="flex items-center justify-between mb-4">
                                <h4 className="text-xl font-semibold text-slate-800 dark:text-slate-100">Stats &amp; Insights</h4>
                            </div>
                            <div className="glass-card rounded-3xl p-6 space-y-4">
                                <div className="flex gap-4 items-center">
                                    <div className="w-16 h-16 rounded-2xl overflow-hidden flex-shrink-0 bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
                                        <span className="material-symbols-outlined text-3xl text-slate-400">monitor_heart</span>
                                    </div>
                                    <div>
                                        <h5 className="font-bold text-sm text-slate-800 dark:text-slate-100">Vital Monitoring</h5>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Stable heart rate and blood pressure recorded last 24h.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-center">
                                    <div className="w-16 h-16 rounded-2xl overflow-hidden flex-shrink-0 bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
                                        <span className="material-symbols-outlined text-3xl text-slate-400">set_meal</span>
                                    </div>
                                    <div>
                                        <h5 className="font-bold text-sm text-slate-800 dark:text-slate-100">Calorie Intake</h5>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Nutritional goals are 85% met for this week's plan.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4 items-center">
                                    <div className="w-16 h-16 rounded-2xl overflow-hidden flex-shrink-0 bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
                                        <span className="material-symbols-outlined text-3xl text-slate-400">bedtime</span>
                                    </div>
                                    <div>
                                        <h5 className="font-bold text-sm text-slate-800 dark:text-slate-100">Sleep Pattern</h5>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Average 7.5 hours of deep sleep. Recovery is optimal.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        <section>
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="flex gap-2">
                                    <button className="w-8 h-8 flex items-center justify-center glass-card rounded-full hover:bg-white dark:hover:bg-slate-700 transition"><span className="material-symbols-outlined text-sm text-slate-600 dark:text-slate-300">chevron_left</span></button>
                                    <button className="w-8 h-8 flex items-center justify-center glass-card rounded-full hover:bg-white dark:hover:bg-slate-700 transition"><span className="material-symbols-outlined text-sm text-slate-600 dark:text-slate-300">chevron_right</span></button>
                                </div>
                            </div>
                                ...
                                <div className="space-y-6">
                                    <div className="relative pl-6 border-l-2 border-indigo-500/30">
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <p className="text-xs text-slate-500 uppercase tracking-tighter mb-1">Diagnosis</p>
                                                <p className="font-bold text-sm text-slate-800 dark:text-slate-100">Stable Recovery (Post-Op)</p>
                                            </div>
                                            <span className="text-[10px] text-slate-400 font-medium">12 Oct 2025</span>
                                        </div>
                                    </div>
                                    <div className="relative pl-6 border-l-2 border-indigo-500/30">
                                        <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-indigo-400 border-4 border-white dark:border-slate-800"></div>
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <p className="text-xs text-slate-500 uppercase tracking-tighter mb-1">Medication</p>
                                                <p className="font-bold text-sm text-slate-800 dark:text-slate-100">Amoxicillin 500mg (2x/day)</p>
                                            </div>
                                            <span className="text-[10px] text-slate-400 font-medium">11 Oct 2025</span>
                                        </div>
                                    </div>
                                    <div className="relative pl-6 border-l-2 border-indigo-500/30">
                                        <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-teal-400 border-4 border-white dark:border-slate-800"></div>
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <p className="text-xs text-slate-500 uppercase tracking-tighter mb-1">Lab Results</p>
                                                <p className="font-bold text-sm text-slate-800 dark:text-slate-100">WBC - Normal Range</p>
                                            </div>
                                            <span className="text-[10px] text-slate-400 font-medium">06 Sep 2025</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <aside className="w-80 border-l border-white/20 dark:border-slate-800/50 p-6 glass-panel flex flex-col">
                    ...
                    <div className="mt-auto flex justify-center pt-8">
                        <button onClick={toggleDarkMode} className="p-2 lg:p-3 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors flex items-center gap-3 w-full lg:w-auto">
                            ...
                            <span className="lg:!hidden !block dark:!hidden">Dark Mode</span>
                            <span className="lg:!hidden !hidden dark:!block">Light Mode</span>
                        </button>
                    </div>
                </aside>
            </div>
